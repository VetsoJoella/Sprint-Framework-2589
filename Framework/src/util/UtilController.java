...
public class UtilController {
    ...
    public Object[] matchValues(Method method, HttpServletRequest request) throws Exception{
        ...
        try{ 
            ...
            if (request.getHeader("Content-Type")!=null && request.getHeader("Content-Type").contains("multipart") && (request.getParts() == null || request.getParts().isEmpty())) return formValues ;
                ...
                try {
                    matchValues(objectToCheck,parameters,formValues, request);
    ...
    void matchValues(List<Object> objectToCheck, Parameter[]parameters, Object[] formValues, HttpServletRequest request) throws Exception {
